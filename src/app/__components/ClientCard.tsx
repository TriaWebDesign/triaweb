...
function ClientCard() {
  return (
    <div className=" text-white w-full 1xl:h-auto 1xl:w-full px-8 py-12  bg-contain bg-no-repeat font-Urbanist bg-[url('https://scontent.fdvo1-1.fna.fbcdn.net/v/t1.15752-9/410919042_405222448521416_4623666915804519756_n.png?_nc_cat=109&ccb=1-7&_nc_sid=8cd0a2&_nc_eui2=AeED9NSbOkQpyckzQcwdjGjeT4Q5zpEZ1AxPhDnOkRnUDKgZUzCE-u_eHmw6s5LuunQjNGDi11oUkfimtY4feCLU&_nc_ohc=f82aUxs6byQAX_7mGZW&_nc_ht=scontent.fdvo1-1.fna&oh=03_AdSGOJF4eXVdPncXrcjEd-Yhp1br1Pkt_AZ-GYETO9VJ_Q&oe=65C4BE3E')]">
