  ...
  return (
    <div className="flex flex-col items-center w-full justify-center pb-10 font-urbanist">
      ...
      <div className="flex flex-wrap flex-row justify-between w-10/12 gap-52 pt-14 pb-14 px-14">
        ...
        <div className="bg-[#FFFFFF] flex flex-col justify-start container w-4/12 h-full shadow-md rounded-3xl px-5 py-5">
          ...
          <div className="w-full pt-5">
            <p className="font-bold text-3xl">Mobile App Design</p>
            <p className="text-[#00000080] font-semibold text-sm">
              ...
              <br></br>posuere at nisl eget turpis sagittis nunc. Aliquet et{" "}
              <br></br>ultrices purus, id. Sagittis erat nunc in parturient.
            </p>
          </div>
        ...
        <div className="bg-[#FFFFFF] flex flex-col justify-start container w-4/12 h-full shadow-md rounded-3xl px-5 py-5">
          ...
          <div className="w-full pt-5">
            <p className="font-bold text-3xl">Website Design</p>
            <p className="text-[#00000080] font-semibold text-sm">
              Viverra ut potenti aliquam feugiat dui imperdiet laoreet <br></br>
              tempus sed. Elit cursus est lorem in est id nec. Quis diam{" "}
              <br></br>posuere at nisl eget turpis sagittis nunc. Aliquet et{" "}
        ...
        <div className="bg-[#FFFFFF] flex flex-col justify-start container w-4/12 h-full shadow-md rounded-3xl px-5 py-5">
          ...
          <div className="w-full pt-5">
            <p className="font-bold text-3xl">Graphic Designing</p>
            <p className="text-[#00000080] font-semibold text-sm">
              Viverra ut potenti aliquam feugiat dui imperdiet laoreet <br></br>
              tempus sed. Elit cursus est lorem in est id nec. Quis diam{" "}
              <br></br>posuere at nisl eget turpis sagittis nunc. Aliquet et{" "}
        ...
        <div className="bg-[#FFFFFF] flex flex-col justify-start container w-4/12 h-full shadow-md rounded-3xl px-5 py-5">
          ...
          <div className="w-full pt-5">
            <p className="font-bold text-3xl">Digital Marketing</p>
            <p className="text-[#00000080] font-semibold text-sm">
              Viverra ut potenti aliquam feugiat dui imperdiet laoreet <br></br>
              tempus sed. Elit cursus est lorem in est id nec. Quis diam{" "}
              <br></br>posuere at nisl eget turpis sagittis nunc. Aliquet et{" "}
      ...
      <div className="bg-[#C4C4C426] w-full flex flex-row px-10">
        <div className="flex flex-col justify-evenly 4xl:pt-24 4xl:pb-24 1xl:p-10 gap-5">
          <p className="flex font-semibold text-5xl">
            Join a global team of change-makers.
          </p>
          <p className="items-center font-semibold text-[#00000080] 4xl:pt-6 4xl:pb-6 1xl:w-10/12">
            Viverra ut potenti aliquam feugiat dui imperdiet laoreet tempus sed.
            Elit cursus est <br></br>lorem in est id nec. Quis diam posuere at
            nisl eget turpis sagittis nunc. Aliquet et <br></br>ultrices purus,
            id. Sagittis erat nunc in parturient.
          </p>
          <div className="">
            <button className="bg-[#5188ff] text-white py-2 px-2 rounded-3xl font-bold">
              View Job Openings
        ...
        <div className="4xl:w-9/12 1xl:w-8/12">
