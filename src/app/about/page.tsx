  ...
  return (
    <div className="flex flex-col justify-center items-center w-full bg-[#ffffff] font-urbanist">
      ...
      <div className="flex justify-evenly pt-24 pb-24 bg-[#C4C4C426] w-full overflow-hidden">
        ...
        <p className="flex justify-center items-center text-[#00000080] w-6/12 font-semibold animate-[slideout_700ms]">
          Semper bibendum nisl, fermentum mi convallis. Sed vitae tincidunt{" "}
          <br></br>nunc, aliquam orci. Porttitor faucibus morbi sed senectus
          justo, <br></br>adipiscing augue. Est, in in pretium at libero morbi.
          Euismod viverra <br></br>arcu nisi eu sit. <br></br>Praesent diam non
          imperdiet potenti tristique et. Amet nec.
        </p>
      </div>
      ...
      <div className="w-full">
        ...
        <p className="flex justify-center items-center text-[#00000080] font-semibold text-center">
          Iterdum ac tincidunt molestie facilisis. Nulla at erat odio bibendum
          diam quam. Scelerisque mus vel <br></br>egestas justo, purus consequat
      ...
      <div className="flex flex-row flex-wrap justify-center items-center gap-y-10 gap-x-72 w-8/12 pt-10">
        ...
        <div className="text-center pl-5">
          ...
          <p className="font-semibold text-[#00000080]">
      ...
      <div className="flex justify-evenly pt-24 pb-24  ">
        <div className="bg-[#C4C4C426] px-12 py-12">
          <p className="flex justify-center items-center font-semibold text-5xl">
            Join a global team of <br></br>change-makers.
          </p>
          <p className="items-center font-semibold text-[#00000080] pt-6 pb-6">
            Viverra ut potenti aliquam feugiat dui imperdiet laoreet <br></br>
            tempus sed. Elit cursus est lorem in est id nec. Quis diam <br></br>
            posuere at nisl eget turpis sagittis nunc. Aliquet et <br></br>
            ultrices purus, id. Sagittis erat nunc in parturient.
          </p>
          <button className="bg-[#5188ff] text-white py-2 px-2 rounded-3xl font-bold">
            View Job Openings
          </button>
        </div>
        <div className="">
      ...
      <div className="flex justify-center items-center gap-10 py-5 px-5 pb-20">
        <div className="1xl:w-3/12 4xl:w-4/12">
          <Image
            ...
            height={440}
            width={440}
            className="rounded-tl-lg rounded-tr-md"
          />
          <div className="bg-[#F1F1F3] h-44 4xl:w-102 py-3 px-3 rounded-bl-xl rounded-br-xl flex flex-col justify-between">
            <Link
              href="https://www.youtube.com/watch?v=2yJgwwDcgV8"
              className="font-semibold 4xl:text-2xl 1xl:text-1xl h-10"
            >
              Porttitor pharetra, consectetur <br></br>viverra est nisl a,
              vulputate id.{" "}
            </Link>
        ...
        <div className="1xl:w-3/12 4xl:w-4/12">
          ...
          <div className="bg-[#F1F1F3] h-44 4xl:w-102 py-3 px-3 rounded-bl-xl rounded-br-xl flex flex-col justify-between">
            <Link
              href="https://www.youtube.com/watch?v=mBw3qzf4s18"
              className="font-semibold 4xl:text-2xl 1xl:text-1xl h-10"
            >
              Diam amet non placerat risus <br></br>magna non volutpat.{" "}
            </Link>
            <div className="flex justify-between h-5 items-center">
              <p className="">13 Sept, 2021</p>
              <p className="">Technology</p>
        ...
        <div className="1xl:w-3/12 4xl:w-4/12">
          ...
          <div className="bg-[#F1F1F3] h-44 4xl:w-102 py-3 px-3 rounded-bl-xl rounded-br-xl flex flex-col justify-between">
            <Link
              ...
              className="font-semibold 4xl:text-2xl 1xl:text-1xl h-10"
            >
              Volutpat volutpat turpis risus <br></br>nunc in nisl habitasse
              leo. <br></br>Duis.
            </Link>
            <div className="flex justify-between h-5 items-center">
              <p className="">13 Sept, 2021</p>
